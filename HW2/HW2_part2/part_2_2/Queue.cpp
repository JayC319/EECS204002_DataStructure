...
/*Pop class method*/
/*****************************************************
 *  pops the front element if the Queue is not empty *
 *****************************************************/
template <class T>
void Queue<T>::Pop() {
    if(IsEmpty())
...
/*********************************************
 * returns the capacity of the current queue *
 * *******************************************/
template <class T>
...
/*Front() class method*/
/**************************************************
 *   This returns the front element of the queue  *
 * ************************************************/
template<class T>
...
/*Rear() class method*/
/************************************************
 *  This returns the rear element of the queue  *
 * **********************************************/
template<class T>
...
/*************************************************************
 *  this class method shows property of the queue            *
 * it shows the capacity by using Capacity() class method    *
 * it shows the size by using Size() class method            *
 * it shows the front element by using Front() class method  *
 * it shows the rear element by using Rear class method      *
 * ***********************************************************/
template<class T>
...
/*Show() class method*/
/**************************************
 *  this class method shows the queue *
 * ************************************/
template<class T>
void Queue<T>::Show() {
    cout << "queue: " << endl;
...
/*Merge() class method*/
/**********************************************************************
 *  This class method merges the parameter queue object to the queue  *
 * ********************************************************************/
template<class T>
...
// initialize the class template type, or the complier won't recognize it
